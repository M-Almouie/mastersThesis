...
for fields in classes:   
	...
	for f in files:
		...
		saver = tf.train.import_meta_graph('retina-model1.meta')
		...
		if 'normal' in f:
			...
			tempClass = '2'
		true.append(tempClass)
		tempList = list(result[0])
	
		predicted.append(str(tempList.index(max(tempList))))
		# result is of this format [probabiliy_of_blind probability_of_normal]
		print('File: '+f+', probs: ', str(result[0]))

plot_confusion_matrix(true, predicted, 'Confusion Model1', classes=['0', '1' , '2'])
