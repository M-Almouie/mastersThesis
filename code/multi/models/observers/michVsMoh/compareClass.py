...
# python compareClass.py ../../../processedDataset/datasetV1.0/michaelSet/images/
...
for fields in classes:   
    ...
    for f in files:
        p = f.split('processedDataset/datasetV1.0/michaelSet/images/Phase')
