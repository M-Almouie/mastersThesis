...
def main():
    ...
    train_writer = tf.summary.FileWriter('summary/trainModel6', session.graph)
    test_writer = tf.summary.FileWriter('summary/testModel6')
    ...
    saver.save(session, './retina-model6')
