...
def main():
    ...
    train_writer = tf.summary.FileWriter('summary/trainModel4', session.graph)
    test_writer = tf.summary.FileWriter('summary/testModel4')
    ...
    saver.save(session, './retina-model4')
