...
def main():
    ...
    train_writer = tf.summary.FileWriter('summary/trainModel2', session.graph)
    test_writer = tf.summary.FileWriter('summary/testModel2')
    ...
    saver.save(session, './retina-model2')
