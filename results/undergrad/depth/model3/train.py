...
def main():
    ...
    train_writer = tf.summary.FileWriter('summary/trainModel3', session.graph)
    test_writer = tf.summary.FileWriter('summary/testModel3')
    ...
    saver.save(session, './retina-model3')
