...
def main():
    ...
    train_writer = tf.summary.FileWriter('summary/trainModel5', session.graph)
    test_writer = tf.summary.FileWriter('summary/testModel5')
    ...
    saver.save(session, './retina-model5')
