...
def main():
    ...
    train_writer = tf.summary.FileWriter('summary/trainModel9', session.graph)
    test_writer = tf.summary.FileWriter('summary/testModel9')
    ...
    saver.save(session, './retina-model9')
