...
def main():
    ...
    train_writer = tf.summary.FileWriter('summary/trainBest', session.graph)
    test_writer = tf.summary.FileWriter('summary/testBest')
    ...
    saver.save(session, './retina-modelBest')
